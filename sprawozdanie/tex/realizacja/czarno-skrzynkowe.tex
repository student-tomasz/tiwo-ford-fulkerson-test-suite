...
\emph{Częściowo zrealizowano w klasie NegativeSizeNetworkTest, nie jest możliwe stworzenie sieci z ujemną ilością węzłów.}

\subsubsection{Sieć z $1e9$ węzłów}
\emph{Zrealizowano w klasie HugeNetworkTest, w wyniku uzyskano przepełnienie stosu.}
