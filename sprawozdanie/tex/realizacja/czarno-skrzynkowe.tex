...
Testy na sieciach bez węzłów pośrednich zrealizowano w klasie \texttt{rw.blackbox.JustSourceAndSinkTest}
...
w klasie \texttt{rw.blackbox.SingleVertexTest}.
%%%%% 1 Węzeł pośredni %%%%%
\begin{center}
\begin{tabular}{@{} >{\bfseries}p{0.2\textwidth} @{\hspace{0.02\textwidth}} p{0.6\textwidth} @{}}
    \toprule
...
zebrane w klasie \texttt{rw.blackbox.TwoParallelVerticesTest}.
...
\texttt{rw.blackbox.TwoSerialVerticesTest}.
...
Częściowo zrealizowano w klasie \texttt{rw.blackbox.NegativeSizeNetworkTest}.
...
\texttt{rw.blackbox.HugeFlowNetworkTest}. Ręczne stworzenie sieci przepływu tej
wielkości jest nierealne. Metoda generateEdges z klasy FlowNetworkGenerator
ma złożoność rzędu $O(n^3)$, co znacząco ogranicza możliwości w tym zakresie.
