...
\begin{itemize}[nosep]
    \item Samego źródła.
    \emph{Zrealizowano metodą testCase1.
    \emph{Algorytm poprawnie nie znajduje niezerowego przepływu maksymalnego w sieci
    z samym źródłem.}
    ...
    \emph{Zrealizowano metodą testCase4.}
    ...
    \emph{Zrealizowano metodą testCase5.}
    \emph{Algorytm poprawnie nie znajduje niezerowego
...
\begin{itemize}[nosep]
    ...
    \emph{Zrealizowano jako testCase1.}
    \emph{Algorytm poprawnie nie znajduje niezerowego
    ...
    \emph{Zrealizowano jako testCase3a i testCase3b.}
    ...
    \emph{Zrealizowano jako testCase4a i testCase4b.}
    \emph{Algorytm poprawnie znajduje maksymalny przepływ
    ...
    \emph{Zrealizowano jako testCase5.}
    ...
    \emph{Zrealizowano jako testCase6a i testCase6b.}
    ...
    \emph{Zrealizowano jako testCase10a i testCase10b.}
...
\begin{itemize}[nosep]
    ...
    \emph{Zrealizowano jako testCase1a i testCase1b.}
    \emph{Algorytm poprawnie
    ...
    i z węzła pośredniego do źródła.
    \emph{Zrealizowano jako testCase3.}
    \emph{Algorytm poprawnie nie znajduje niezerowego
    przepływu maksymalnego w sieci bez ścieżki od źródła do ujścia.}
    % Z <- P -> U
    ...
    \emph{Zrealizowano jako testCase4.}
    \emph{Algorytm poprawnie nie znajduje niezerowego
    przepływu maksymalnego w sieci bez ścieżki od źródła do ujścia.}
    % Z -> P <- U
    ...
    \emph{Zrealizowano jako testCase7a, testCase7b i testCase7c.}
    \emph{Algorytm poprawnie
    ...
    \emph{Zrealizowano jako testCase8.}
    \emph{Algorytm poprawnie nie znajduje niezerowego
    przepływu maksymalnego w sieci bez ścieżki od źródła do ujścia.}
    % Z -> P    U
    ...
    \emph{Zrealizowano jako testCase9.}
    \emph{Algorytm poprawnie znajduje maksymalny
    przepływ w sieci.}
    % Z -> P    U
    % |_________^
    ...
    \emph{Zrealizowano jako testCase10.}
    \emph{Algorytm poprawnie nie znajduje niezerowego
    przepływu maksymalnego w sieci bez ścieżki od źródła do ujścia.}
    % Z    P -> U
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \emph{Zrealizowano jako testCase6.}
    \emph{Algorytm poprawnie znajduje maksymalny przepływ.}
