...
\begin{itemize}[nosep]
    ...
    \emph{Zrealizowano. Algorytm poprawnie znajduje maksymalny przepływ w sieci.}
    % Z -> P -> U

    \item Z pojedynczymi krawędziami skierowanymi z ujścia do węzła pośredniego
    i z węzła pośredniego do źródła.
    \emph{Zrealizowano. Algorytm poprawnie nie znajduje niezerowego przepływu
    ...
    \emph{Zrealizowano. Algorytm poprawnie znajduje maksymalny przepływ w sieci.
    Algorytm nie informuje o istnieniu pętli w sieci.}
    % Z -> P -> U
    %     / ^
    %     \_|
    ...
    \emph{Zrealizowano. Algorytm poprawnie znajduje maksymalny przepływ w sieci
    o pojedynczych krawędziach. W przypadku zwielokrotnienia krawędzi algorytm
    nie jest w stanie wyznaczyć prawidłowego maksymalnego przepływu w sieci.}
    % Z -> P -> U
    %  ^__/ ^__/
...
\begin{itemize}[nosep]
    ...
    \emph{Zrealizowano. Zwraca niepoprawną wartość.}

    \item Sieć z 2 węzłami pośrednimi połączonymi szeregowo z krawędzią o
    zerowej przepustowości pomiędzy węzłami pośrednimi.
    \emph{Zrealizowano. Poprawnie nie znajduje niezerowego maksymalnego przepływu
