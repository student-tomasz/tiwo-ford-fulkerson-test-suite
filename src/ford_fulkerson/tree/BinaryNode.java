package ford_fulkerson.tree;

import ford_fulkerson.debug.IGraphEntity;
import ford_fulkerson.IBinaryTreeNode;
...
public class BinaryNode<T extends Comparable> implements IBinaryTreeNode, IGraphEntity {
