...
\begin{itemize}[nosep]
    ...
    \item\texttt{DFS_SearchArray} implementująca algorytm Deep\dywiz First\dywiz Search do wykorzystania na sieciach przepływowych z \texttt{FlowNetworkArray}, która jest wymagana jako drugi argument konstruktura klasy \texttt{FordFulkerson}
\end{itemize}
