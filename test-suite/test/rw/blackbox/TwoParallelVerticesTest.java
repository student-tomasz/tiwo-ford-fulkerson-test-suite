...
public class TwoParallelVerticesTest {
    ...
    public void testCase2() throws Exception {
        ...
        assertEquals(flowNetwork.getFlow(), 8, "Wyznaczony przepływ jest inny niż określa wyrocznia.");
    ...
    public void testCase4() throws Exception {
        preIterator = new ArrayList(); // krawedzie i ich przepustowosc
        EdgeInfo edge1 = new EdgeInfo(0, 1, 17);
        EdgeInfo edge2 = new EdgeInfo(0, 2, 11);
        EdgeInfo edge3 = new EdgeInfo(1, 3, 5);
        EdgeInfo edge4 = new EdgeInfo(2, 3, 3);
    ...
    public void testCase5() throws Exception {
        ...
        assertEquals(flowNetwork.getFlow(), 10, "Wyznaczony przepływ jest inny niż określa wyrocznia.");
