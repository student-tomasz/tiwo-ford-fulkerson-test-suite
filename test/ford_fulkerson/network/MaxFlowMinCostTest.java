...
import ford_fulkerson.network.Assignment;
import ford_fulkerson.network.DisjointPairs;
import ford_fulkerson.network.EdgeInfo;
import ford_fulkerson.network.FlowNetworkArray;
import ford_fulkerson.network.BipartiteMatchingMinCost;
import ford_fulkerson.network.ShortestPathArray;
import ford_fulkerson.network.FordFulkerson;
import ford_fulkerson.network.Transportation;
import ford_fulkerson.network.Transshipment;
...
public class MaxFlowMinCostTest extends TestCase {
	...
	public void testBipartiteMatching() {
		String pairings[] = new String[] {"Ann Adam",
		"Ann Bob",
		"Beth Adam",
		"Beth Carl",
		"Christina Dan",
