...
\item{Ustaw początek krawędzi \emph{(u)} na wierzchołek poprzedzający koniec aktualnej krawędzi\emph{(v)}}
\item{Jeśli aktualna krawędź \emph{(u,b)} nie jest krawędzią przednią, przejdź do punktu 9}
